...
| FR-ML-003 | `src/search_rank/training/trainer.py`, `training/diagnostics.py` | Tiny-overfit, pre-data deterministic device forward/backward preflight, explicit mining-device cleanup, allowlisted stage-failure, and epoch-provenance tests; candidate run evidence pending |
